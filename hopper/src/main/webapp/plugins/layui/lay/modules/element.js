...
layui.define('jquery', function(exports){
  ...
  //动态改变进度条
  Element.prototype.progress = function(filter, percent,changeCss){
    ...
    if(changeCss){
    	var s = percent.substring(0,percent.length-1);
        var x = Math.round(s); 
        if(x<=20){
        	elemBar.css("cssText",'background-color:#5FB878 !important;width:'+percent+';');
        }
        if(x>20 && x<=50){
        	elemBar.css("cssText",'background-color:#009688 !important;width:'+percent+';');
        }
        if(x>50 && x<=80){
        	elemBar.css("cssText",'background-color:#FFB800 !important;width:'+percent+';');
        }
        if(x>80){
        	elemBar.css("cssText",'background-color:#FF5722 !important;width:'+percent+';');
        }
    }
