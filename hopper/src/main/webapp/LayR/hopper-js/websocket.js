;layui.define(['jquery','stomp'], function(exports) {
...
//	    http://stevesouders.com/misc/test-postmessage.php
	...
	//# sourceMappingURL=sockjs.js.maps
	...
	Sock.prototype.init = function(url) {
		var _this = this;
    ...
    Sock.prototype.subscribe1 = function(topic,subscribe) {
		var _this = this;
		_this.stompClient.connect({},function(frame){
			
			 console.log('Connected: ' + frame);
			if (subscribe&&typeof(subscribe) == 'function' ) {
	        	_this.stompClient.subscribe( topic,subscribe);
	        }
		})
    ...
    Sock.prototype.subscribe = function(topic,subscribe) {
		var _this = this;
	...
	Sock.prototype.connect = function(subscribe) {
		var _this = this;
		_this.stompClient.connect({},subscribe);
        return _this;
    };
	
    var sock = new Sock();
	exports('websocket',function(url){
		return sock.init(url);
	});
});