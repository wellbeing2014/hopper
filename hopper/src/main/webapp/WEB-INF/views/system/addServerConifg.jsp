...
<article class="cl pd-20">
	<form action="/system1/addTomcat.json" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="plat" type="radio" value="1" id="plat-1" checked>
					<label for="plat-1">X64</label>
				</div>
				<div class="radio-box">
					<input name="plat" type="radio" value="2" id="plat-2" >
